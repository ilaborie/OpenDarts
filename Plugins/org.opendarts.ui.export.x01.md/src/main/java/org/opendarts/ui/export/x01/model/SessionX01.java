 ...
 */
public class SessionX01 extends Session {
	 ...
	 */
	public SessionX01(ISession parent, List<IStatsService> statsServices) {
	...
	public List<Set> getSets() {
		if (sets == null) {
			...
			for (ISet set : this.getElement().getAllGame()) {
				this.sets.add(new SetX01(this, set, this.getStatsServices()));
			}
		}
		return this.sets;
	}
