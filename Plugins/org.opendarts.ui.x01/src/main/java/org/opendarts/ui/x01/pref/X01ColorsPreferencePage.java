 ...
 */
public class X01ColorsPreferencePage extends FieldEditorPreferencePage
	...
	*/
	...
	protected void createFieldEditors() {
		...
		// Normal
		editor = new ColorFieldEditor(COLOR_NORMAL, "Base score color", parent);
		...
		// 60
		editor = new ColorFieldEditor(COLOR_60, "60 color", parent);
		this.addField(editor);
		...
		// 100
		editor = new ColorFieldEditor(COLOR_100, "100 color", parent);
		this.addField(editor);
		...
		// 60
		editor = new ColorFieldEditor(COLOR_180, "180 color", parent);
		this.addField(editor);
	}
