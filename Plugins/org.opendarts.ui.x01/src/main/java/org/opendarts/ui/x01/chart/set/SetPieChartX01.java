 ...
 */
public abstract class SetPieChartX01<T> implements IChart {
	 ...
	 */
	public SetPieChartX01(String name, String statKey, ISet set) {
		super();
		this.name = name;
	...
	protected List<IPlayer> getAllPlayers() {
		Set<IPlayer> players = new HashSet<IPlayer>(this.set
