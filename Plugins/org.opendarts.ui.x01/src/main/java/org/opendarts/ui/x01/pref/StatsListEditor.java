...
public class StatsListEditor extends ListViewerEditor<String>{
	 ...
	 */
	public StatsListEditor(String key, String labelText, Composite parent, List<String> availableStats) {
	...
	protected ColumnLabelProvider getLabelProvider() {
		return new StatsLabelProvider(OpenDartsX01Bundle.getStatsX01Service());
	}
	...
	protected String getNewInputObject() {
		...
		StatsSelectionDialog dialog = new StatsSelectionDialog(this.parentShell, statsEntries);
